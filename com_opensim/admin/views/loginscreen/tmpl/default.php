...
<tr>
	...
	<div class="btn btn-disabled jopensimbuttondisabled" title="<?php echo JText::_('JOPENSIM_LOGINSCREEN_POSITIONMODULE_SELECT1ST'); ?>"><span class="icon-eye-blocked"></span></div>
	<?php elseif($position['active'] == 1): ?>
	<a class="btn jopensimbuttongreen" href="index.php?option=com_opensim&view=loginscreen&task=setPosInvisible&id=<?php echo $position['id']; ?>"><span class="icon-eye-open"></span></a>
	<?php else: ?>
	<a class="btn jopensimbuttonred" href="index.php?option=com_opensim&view=loginscreen&task=setPosVisible&id=<?php echo $position['id']; ?>"><span class="icon-eye-blocked"></span></a>
	<?php endif; ?>
	</td>
...
<p><a href="<?php echo JURI::root(); ?>index.php?option=com_opensim" target="_blank"><?php echo JText::_('JOPENSIM_LOGINSCREEN_PREVIEW'); ?></a></p>
