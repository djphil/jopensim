...
<table cellspacing="5" border='0' class="table table-striped table-hover adminlist">
    <thead>
        <tr>
            ...
            <th class='title'>&nbsp;</th>
            <th class='title'><?php echo JText::_('JOPENSIM_VISIBLE'); ?></th>
            <th class='title'><?php echo JText::_('JOPENSIM_REGION_RATING'); ?></th>
    ...
    <tbody>
        ...
        <tr class="row<?php echo $i % 2; ?>">
            ...
            <td align='center'>
				...
				<?php else: ?>
				<?php if($this->canDo->get('core.edit')): ?>
				<a class="btn btn-micro hasTooltip" href="index.php?option=com_opensim&view=maps&task=selectdefault&region=<?php echo $region['uuid']; ?>" data-original-title="<?php echo JText::_('JLIB_HTML_SETDEFAULT_ITEM'); ?>" title="<?php echo JText::_('JLIB_HTML_SETDEFAULT_ITEM'); ?>">
				<?php endif; ?>
            ...
            <td align="center">
				<?php if($this->canDo->get('core.edit')): ?>
                <a class="btn btn-micro hasTooltip" href="index.php?option=com_opensim&view=maps&task=<?php echo (array_key_exists("public",$region) && $region['public'] == 1) ? "setRegionUnpublic":"setRegionPublic"; ?>&region=<?php echo $region['uuid']; ?>" data-original-title="<?php echo $publictitle; ?>" title="">
                <?php endif; ?>
                <i class="fa <?php echo $publicicon." ".$publicclass; ?>"></i>
				<?php if($this->canDo->get('core.edit')): ?>
                </a>
                <?php endif; ?>
            </td>
            <td align="center">
				<?php if($this->canDo->get('core.edit')): ?>
				<a class="btn btn-micro hasTooltip" href="index.php?option=com_opensim&view=maps&task=<?php echo (array_key_exists("guide",$region) && $region['guide'] == 1) ? "setRegionGuideHide":"setRegionGuideShow"; ?>&region=<?php echo $region['uuid']; ?>" data-original-title="<?php echo $guidetitle; ?>" title="">
                <?php endif; ?>
                <i class="fa <?php echo $guideicon." ".$guideclass; ?>"></i>
				<?php if($this->canDo->get('core.edit')): ?>
                </a>
                <?php endif; ?>
            </td>
            ...
            <td align='center' class='jgrid'>
                ...
                <?php endif; ?>
                <i class="icon-<?php echo ($region['hidemap'] == 1) ? "unpublish":"publish"; ?>"></i>
				<?php if($this->canDo->get('core.edit')): ?>
                </a>
                <?php endif; ?>
            </td>
            <td><?php echo $this->regionrating[$region['access']]; ?></td>
