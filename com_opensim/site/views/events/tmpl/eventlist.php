...
<tr>
	...
	<td>
		<?php if($event['editflag'] == 1): ?>
            <a class='btn btn-danger btn-small pull-right' href='<?php echo JRoute::_('&option=com_opensim&view=events&layout=eventlist&task=deleteevent&eventid='.$event['eventid']); ?>' onClick='return confirm("<?php echo JText::_('JOPENSIM_EVENT_DELETE_SURE'); ?>");' alt='<?php echo JText::_('JOPENSIM_EVENT_DELETE'); ?>' title='<?php echo JText::_('JOPENSIM_EVENT_DELETE'); ?>'><strong>X</strong></a>
		<?php else: ?>&nbsp;<?php endif; ?>
	</td>
</tr>
