...
if (!defined('_OPENSIMCLASS_GS')) define("_OPENSIMCLASS_GS",JPATH_BASE.DS."components".DS."com_opensim".DS."includes".DS."opensim.class.php");
...
if (is_file(_OPENSIMCLASS_GS)) {
    ...
    $component['showtodayvisitors'] = $comp_params->get('loginscreen_show_todayvisitors');
    ...
    $parameter['showtodayvisitors'] = $params->get('showtodayvisitors');
    ...
    // in standalone, the database table most probably will not exist
    $parameter['hiddenregions']     = 1;
}
