...
class mod_opensim_jsonstatsInstallerScript {
    /**
     * Constructor
     *
    ...
    public function description() {
        $github = "https://github.com/djphil/mod_opensim_jsonstats";
        ...
        echo "<p>".JText::_('MOD_OPENSIM_JSONSTATS_GITHUB_URL_DESC')." ".$github."</p>\n";
        echo "<p><img src='".JUri::base(false)."../modules/mod_opensim_jsonstats/assets/images/creative_80x15.png' alt='jopensim' height='15' width='80'></p>\n";
