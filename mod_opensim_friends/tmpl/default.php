...
<?php if(count($friendlist) > 0): ?>
	<?php if($useaccordion == 1): ?>
		<style>#jOpenSim_friends_container {max-height:<?php echo $accordioninit; ?>px;}</style>
		<script>
	...
	<?php endif; ?>
		...
		<?php if ($useaccordion == 1): ?>
			<div id='jOpenSimFriendsShowMore' class="btn <?php echo $accordionclass; ?>"><?php echo JText::_('MOD_OPENSIM_FRIENDS_SHOWMORE'); ?></div>
		<?php endif; ?>
	</div>
<?php endif; ?>
