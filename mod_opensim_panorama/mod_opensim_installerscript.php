...
class mod_opensim_panoramaInstallerScript {
    /**
     * Constructor
     *
    ...
    public function description() {
        $github = "https://github.com/djphil/mod_opensim_panorama";
        ...
        echo "<p>".JText::_('MOD_OPENSIM_PANORAMA_GITHUB_URL_DESC')." ".$github."</p>\n";
        echo "<p><img src='".JUri::base(false)."../modules/mod_opensim_panorama/assets/images/creative_80x15.png' alt='jopensim' height='15' width='80'></p>\n";
